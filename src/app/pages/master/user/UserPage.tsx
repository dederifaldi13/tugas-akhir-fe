...
import FormAddNewUser from './component/FormAddNewUser'
import TableUser from './component/TableUser'
import {GetMasterUser, PostUser} from './redux/action/UserAction'
      ...
      <div className='row'>
        <div className='col-lg-12'>
          <Modal show={show} onHide={handleClose} centered size='lg'>
            ...
            <Modal.Body>
              <FormAddNewUser onSubmit={(data: any) => handleSubmit(data)} />
            </Modal.Body>
            <Modal.Footer>
        ...
        <div className='col-lg-12'>
          <div className='card card-custom'>
            <div className='card-body p-9'>
              <PageTitle breadcrumbs={[]}>Master User</PageTitle>
