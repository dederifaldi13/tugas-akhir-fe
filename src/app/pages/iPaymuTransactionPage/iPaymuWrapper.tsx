...
import FormTransaction from './component/FormTransactioniPaymu'
import {ConfirmPaymentAction, GetDataQR, GetTransactionFilter} from './redux/action/iPaymuAction'

const IPaymuWrapper: FC = () => {
  const params: {
    kode_toko: string
    product: string
    kode_cabang: string
  ...
  const dataTrx: any = useSelector<RootState>(({paymentqr}) => paymentqr.feedback)
